...
public class AotTestContextInitializers__Generated {
  public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers(
    ...
    map.put("com.ufcg.psoft.mercadofacil.VolatilLoteRepositoryTest", () -> new MercadofacilApplicationTests__TestContext001_ApplicationContextInitializer());
    return map;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses(
    ...
    map.put("com.ufcg.psoft.mercadofacil.VolatilLoteRepositoryTest", MercadofacilApplicationTests__TestContext001_ApplicationContextInitializer.class);
    return map;
  }
}
